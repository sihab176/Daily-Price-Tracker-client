  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="shadow-lg rounded-2xl bg-[#84a98c] text-white">
          <div className="p-6">
            <h2 className="text-lg font-semibold">Total Users</h2>
            <p className="text-3xl font-bold">{totalUser}</p>
          </div>
        </div>
        <div className="shadow-lg rounded-2xl bg-gradient-to-r from-[#003566] to-[#001d3d] text-white">
          <div className="p-6">
        ...
        <div className="shadow-lg rounded-2xl bg-gradient-to-r from-[#ffcad4] to-[#f4acb7] text-white">
          <div className="p-6">
